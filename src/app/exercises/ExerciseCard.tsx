          ...
          <div className="flex items-center gap-3">
              ...
              <>
                ...
                <span className="flex items-center gap-1">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-3 h-3 opacity-50">
                    ...
                    <path fillRule="evenodd" d="M1 8a7 7 0 1 1 14 0A7 7 0 0 1 1 8Zm12.5 0A5.5 5.5 0 1 1 2.5 8 5.5 5.5 0 0 1 13.5 8Z" clipRule="evenodd" />
                  </svg>
            ...
            {exercise.images.length > 0 && (
              <>
                ...
                <span className="flex items-center gap-1">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-3 h-3 opacity-50">
                    <path fillRule="evenodd" d="M2 4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4Zm10.5 2a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0ZM4 4h8v4.428l-2.09-2.09a1.5 1.5 0 0 0-2.12 0L4 10.139V4Zm8 8H4v-.639l4.29-4.29a.5.5 0 0 1 .708 0L12 10.071V12Z" clipRule="evenodd" />
                  </svg>
