    ...
    <div className="space-y-24 pb-12">
      ...
      <section className="relative pt-12 pb-8 px-4 sm:px-0">
        <div className="text-center space-y-10 relative">
          <div
            className="w-full max-w-3xl mx-auto animate-in"
          ...
          <div className="space-y-6">
            <h1
              className="text-5xl font-black tracking-tight sm:text-7xl bg-gradient-to-r from-primary-400 via-primary-500 to-accent-500 bg-clip-text text-transparent animate-in inline-block"
              style={{ animationDelay: "0.1s" }}
            >
              Rutinea
            </h1>
            <p
              className="text-xl text-text-secondary max-w-2xl mx-auto leading-relaxed animate-in font-medium"
              style={{ animationDelay: "0.2s" }}
            >
              Diseña tus propios entrenamientos con absoluta libertad o
              <span className="text-primary-400">
                {" "}
                clona planes de otros y edítalos a tu medida.
              </span>
            </p>
          </div>

          <div
            className="flex flex-col sm:flex-row justify-center gap-4 animate-in"
          ...
          <p
            className="text-2xl font-bold max-w-2xl mx-auto bg-gradient-to-r from-primary-400 to-accent-500 bg-clip-text text-transparent animate-in"
      ...
      <section
        className="relative py-12 px-8 rounded-[2.5rem] bg-surface border border-white/5 overflow-hidden group animate-in"
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-lg text-text-secondary leading-relaxed font-medium">
              ¿No sabes por dónde empezar? Explora la biblioteca de planes
              creados por otros atletas.
              <span className="text-white">
                {" "}
                Con un solo clic puedes clonar cualquier plan
              </span>
              , adaptarlo a tu nivel y hacerlo tuyo. Tu entrenamiento, tus
              reglas.
            </p>
            <div className="flex gap-4">
              <Link
                href="/plans"
                className="text-primary-400 font-bold hover:underline inline-flex items-center gap-2"
              >
                Explorar biblioteca
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="shrink-0 w-full md:w-64 aspect-square bg-gradient-to-br from-primary-500/20 to-accent-500/20 rounded-3xl border border-white/5 flex items-center justify-center relative">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-24 h-24 text-primary-400/80 drop-shadow-glow"
            >
              <path
                strokeLinecap="round"
      ...
      {/* CTA */}
      <section
        className="relative rounded-[3rem] overflow-hidden mx-auto max-w-4xl shadow-2xl group animate-in"
      ...
      >
        ...
        <div className="relative text-center space-y-8 px-6 py-12 sm:px-12 sm:py-20">
          ...
          <p className="text-primary-100 text-lg sm:text-xl max-w-2xl mx-auto font-medium">
            Únete a otros atletas que ya están transformando su rutina. Sin
            complicaciones, sin distracciones, solo resultados.
          </p>
