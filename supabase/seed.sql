...
values (
        ...
        '{"barra","piernas"}',
        '{"Mantén la espalda recta","No dejes que las rodillas pasen los pies"}',
        9
    ),
    (
        'Bench Press',
        ...
        '{"banco","barra","pecho"}',
        '{"Baja la barra controladamente","Aprieta los omóplatos"}',
        12
    ),
    (
        'Deadlift',
        ...
        '{"Empuja el suelo con los pies","Mantén la barra cerca del cuerpo","Activa el core"}',
        20
    );